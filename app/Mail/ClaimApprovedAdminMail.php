...
class ClaimApprovedAdminMail extends Mailable
{
    ...
    {
        return new Envelope(
            subject: 'Claim request for ' . $this->school->name . ' has been approved successfully!',
        );
    }
    ...
    {
        return new Content(
            markdown: 'emails.claims.approved_admin_claim_notification',
            with: [
                'user' => $this->user,
                'school' => $this->school,
