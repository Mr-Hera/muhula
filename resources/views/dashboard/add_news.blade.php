   ...
   <div class="container-fluid top-container">
      <div class="row">
         ...
         <div class="dashboard_right_panel">
            ...
            {{-- Add / Manage News navigation --}}
            <div class="my_review_btn2">
               <a href="{{ route('user.add.news') }}" class="rev_active">Add News</a>
               <a href="{{ route('user.manage.news') }}">Manage News</a>
            </div>
                  ...
                  <div class="row">
                     <div class="col-sm-12 cols">
                        ...
                        <div class="col-lg-12 col-xl-12 col-sm-12 col-md-12">
                           <div class="dash_input mb-3">
                              <label>Excerpt</label>
                              <input type="text" name="news_excerpt" placeholder="Enter here">
                           </div>
                        </div>
                        ...
                        <div class="col-lg-6 col-xl-4 col-sm-6 col-md-6 col-12 cols">
                           ...
                           <label id="image_error" class="error" style="display:none;"></label>
                        </div>

                        <div class="col-lg-4 col-xl-3 col-sm-6 col-md-3 col-12 cols cols_img">
                           <div class="sch_show_img uploadImage"></div>
                        </div>
...
$(document).ready(function(){
   $('#newsForm').validate({
      rules: {
         ...
         news_image: { required: true },
      },
      submitHandler: function(form){
         let filename = $('#news_image').val();
         if(filename == ''){
            $('#image_error').html('Please upload a news image').show();
            return false;
         }
         form.submit();
      },
