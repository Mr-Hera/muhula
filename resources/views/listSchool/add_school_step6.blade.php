                                 ...
                                 <div class="added-subs-div">
                                   {{-- @if(@$school_subject->isNotEmpty())
                                    ...
                                    <div class="added-subs-box position-relative">
                                       <a href="{{ route('add.school.step6',[md5(@$schoolDetails->id),@$data->id]) }}" class="edit-subs" style="right: 42px">
                                       ...
                                       <a href="{{ route('school.subject.delete',[@$data->id]) }}" class="edit-subs" onclick="return confirm('Do you want to delete this subject?')">
