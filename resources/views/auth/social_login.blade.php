                  ...
                  <div class="login_from_body mt-3">
                     ...
                     @include('includes.message')
                        ...
                        <div class="login_froms">
                           <form action="{{route('login.social.register')}}" method="post" id="register-form">
                              @csrf
                              ...
                              <div class="row">
                                 <div class="col-sm-6">
                                    <div class="login_input">
                                       ...
                                       <input type="text" name="first_name" id="first_name" placeholder="Enter here" value="{{ @$user_data['fname'] }}">
                                    </div>
                                 </div>
                                 <div class="col-sm-6">
                                    <div class="login_input">
                                       <label>Last name </label>
                                       <input type="text" name="last_name" id="last_name" placeholder="Enter here" value="{{ @$user_data['lname'] }}">
                                    </div>
                                 </div>
                              </div>
                              <div class="login_input">
                                 <label>Email </label>
                                 <input type="text" name="email" id="email" placeholder="Enter here" value="{{@$user->email}}">
                              </div>
