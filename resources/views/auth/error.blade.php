...
<section class="login_main_section for_sucess_msg">
    ...
    <div class="container">
           ...
           <div class="mesg-cls success-cls">
              ...
              <span class="img-span"><img width="100" src="{{asset('public/images/faliure.png')}}" alt="" class="img-fit"></span>

              <h2 class="thankyou">Opps !!</h2>

              @if(Session::has('error'))

                 <div class="alert alert-success blue-success error_bgg" role="alert">
