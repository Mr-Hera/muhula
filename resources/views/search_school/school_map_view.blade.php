...
<section class="inner_banner">
         <img src="{{ url('public/images/inner-banner.png') }}" alt="" class="innr-bnnr-img ">
         <div class="in-bn-txt">
         <div class="container ">
         ...
         <div class="container">
            <div class="row">
               <div class="result_div">
                  ...
                  <form action="{{ route('school.search.map') }}" class="sorts-srch d-flex" method="post">
                        @csrf
                        <div class="search_in">
                ...
                <input type="hidden" name="sort_by" id="sort_by">
                  <div class="serach_panels left-bar">
                     <div class="top_toggle">
                        <ul>
                           <li><a class="active" href="{{ route('school.search.map') }}"> <img src="{{ url('public/images/location1.png') }}" alt=""> Map View</a> </li>
                           <li><a class="" href="{{ route('school.search') }}"> <img src="{{ url('public/images/list1.png') }}" alt=""> Listing View</a> </li>
                        </ul>
                     </div>
                     ...
                     <div class="search_cirtariya">
                              ...
                              <div class="col-6 col-sm-4 col-md-3 col-lg-6">
                                 <div class="radio_post">
                                    ...
                                    <label for="control_01">
                                       <img src="{{ url('public/images/school.png') }}" alt="" class="dis_b">
                                       <p>Private School</p>
                                    </label>
                                 </div>
                              </div>
                        ...
                        <div class="check_short">
                           ...
                           <ul class="category-ul agree">
                                       @if(@$school_type)
                                       @foreach($school_type as $keyy=>$type)
                                       <li>
                                          <div class="radiobx">
                                             <label for="">{{ @$type->school_type }}
                                                  <input type="checkbox" value="{{ @$type->id }}" name="school_type[]" id="agree{{ @$keyy+1 }}" @if(@$key['school_type']) {{ in_array(@$type->id,@$key['school_type'])?'checked':'' }} @endif>
                           ...
                           <div class="sort_divs">
                              ...
                              <option value="{{ @$data->id }}" @if(@$key['town'] == @$data->id) selected @endif>{{ @$data->city }}</option>
                              @endforeach
                              @endif
                              </select>
                           </div>
                           ...
                           <div class="check_course">
                              <ul class="">
                                 @if(@$subjects)
                                 @foreach($subjects as $keyy=>$subject)
                                 <div class="{{$keyy>12 ? 'hide_labelCheckBoxJobRole' :''}}">                                 
                                 <li>
                                    <input  type="checkbox" name="school_subject[]" id="control_0{{ @$keyy+3 }}"  value="{{ @$subject->id }}" @if(@$key['school_subject']) {{ in_array(@$subject->id,@$key['school_subject'])?'checked':'' }} @endif>
                                    <label for="control_0{{ @$keyy+3 }}">
                                       <p>{{ @$subject->subject }}</p>
                                    </label>
                                 </li>
                                 </div>
                        ...
                        <div class="check_short">
                           ...
                           <div class="check_gender">
                              <ul>
                                 <li>
                                    <input  type="checkbox" name="gender[]" id="gender_01" value="M" @if(@$key['gender']) {{ in_array('M',@$key['gender'])?'checked':'' }} @endif>
                                    <label for="gender_01">
                                       <p>Male</p>
                                    </label>
                                 </li>
                                 <li>
                                    <input  type="checkbox" name="gender[]" id="gender_02"  value="F" @if(@$key['gender']) {{ in_array('F',@$key['gender'])?'checked':'' }} @endif>
                                    <label for="gender_02">
                                       <p>Female</p>
                                    </label>
                                 </li>
                                 <li>
                                    <input  type="checkbox" name="gender[]" id="gender_03" value="B" @if(@$key['gender']) {{ in_array('B',@$key['gender'])?'checked':'' }} @endif>
                                    <label for="gender_03">
                                       <p>Both</p>
                                    </label>
                                 </li>
                        ...
                        <div class="check_short">
                           ...
                           <div class="check_gender">
                              <ul>
                                 <li>
                                    <input  type="checkbox" name="boarding_type[]" id="type_01"  value="D" @if(@$key['boarding_type']) {{ in_array('D',@$key['boarding_type'])?'checked':'' }} @endif>
                                    <label for="type_01">
                                       <p>Day</p>
                                    </label>
                                 </li>
                                 <li>
                                    <input  type="checkbox" name="boarding_type[]" id="type_02"  value="B" @if(@$key['boarding_type']) {{ in_array('B',@$key['boarding_type'])?'checked':'' }} @endif>
                                    <label for="type_02">
                                       <p>Boarding</p>
                                    </label>
                                 </li>
                                 <li>
                                    <input  type="checkbox" name="boarding_type[]" id="type_03" value="DB" @if(@$key['boarding_type']) {{ in_array('DB',@$key['boarding_type'])?'checked':'' }} @endif>
                                    <label for="type_03">
                                       <p>Day & Boarding</p>
                                    </label>
                                 </li>
                                          ...
                                          <div class="radiobx">
                                             <label for="">
                                                <ul class="start_ca">
                                                      ...
                                                      <li>
                                                         <img src="{{ url('public/images/lstar.png') }}" alt="">
                                                      </li>
                                                      <li>
                                                         <img src="{{ url('public/images/lstar.png') }}" alt="">
                                                      </li>
               ...
               <div class="right_panel_serach ">
                  <div class="new_fixed_area">
                     <div class="new_ares" id="map">
                        ...
                        {{--<div class="map_lac1">
                          <a href="#"><img src="{{ url('public/images/location2.png') }}" alt=""></a> 
                        </div>
                        <div class="map_lac2">
                          <a href="#"><img src="{{ url('public/images/location2.png') }}" alt=""></a>
                        </div>
